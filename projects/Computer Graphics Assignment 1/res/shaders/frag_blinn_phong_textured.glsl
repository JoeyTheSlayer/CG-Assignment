...
//Add Stuff For Toon Shading
 ...
 uniform int u_BothLights;
 uniform int u_AmbLights;
 uniform int u_SpecLights;
 uniform int u_NoLights;
 uniform int u_AmbSpecShader;
...
void main() {
	...
	if (u_AmbSpecShader == 1)
	{
		//Set up the diffuse for the cell shading
